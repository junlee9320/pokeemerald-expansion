...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    ...
    { ITEM_SODA_POP,        {   _,   3,   3,   4,   4,   4,   4,   5,   9,  10, } },
    { ITEM_LEMONADE,        {   _,   3,   3,   4,   4,   4,   4,   5,   9,  10, } },
    { ITEM_FRESH_WATER,     {   _,   1,   1,   1,   1,   4,   4,   5,   4,   5, } },
    { ITEM_NUGGET,          {   _,   _,   3,   4,   4,   4,   4,   5,   4,   5, } },
    { ITEM_MAX_POTION,      {   _,   _,   3,   4,   4,   4,   8,   8,   9,  30, } },
    { ITEM_MAX_ETHER,       {   _,   _,   1,   1,   4,   4,   4,   _,   _,   _, } },
    { ITEM_DIRE_HIT,        {   _,   _,   1,   1,   1,   4,   4,   5,   4,   5, } },
    { ITEM_BIG_NUGGET,      {   _,   _,   1,   1,   1,   1,   4,   5,   4,   5, } },
    { ITEM_X_ATTACK,        {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_X_DEFENSE,       {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_X_ACCURACY,      {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_X_SP_ATK,        {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_X_SP_DEF,        {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    ...
    { ITEM_GUARD_SPEC,      {   _,   _,   _,   _,   _,   _,   _,   1,   1,   1, } },
};
