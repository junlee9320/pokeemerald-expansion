...
static u32 ChooseWildMonIndex_Fishing(u8 rod)
{
    u8 wildMonIndex = 0;
    bool8 swap = FALSE;
    // edited this line below to only look at super rod encounters because old/good encounters don't exist
    ...
    switch (rod)
    {
    case OLD_ROD: // old rod encounters don't exist
        ...
        break;
    case GOOD_ROD: // good rod encounters don't exist
