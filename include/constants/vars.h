...
#define VAR_DEWFORD_GYM_STATE                            0x4052 // changed from VAR_DEWFORD_TOWN_STATE TO VAR_DEWFORD_GYM_STATE, checks that brawly is defeated before going to slateport
